...
<html>
	...
	<head>
		...
		<script type="text/javascript" language="javascript" src="js/datatable_paciente.js"></script>
		...
		<div class="panel panel-primary" id="content_table">
    		<div class="panel-heading">
        		<h3 class="panel-title"><i class="fas fa-file-signature"></i>  SISTEMA SEGUIMIENTO PACIENTES COVID-19</h3>
    				...
    				<div class="alert alert-success" style="font-size: 13pt; font-weight: bold;"><i class="fas fa-external-link-alt"></i>  Pacientes COVID-19
					</div> 

						<!--BOTÓN PARA AÑADIR NUEVO PACIENTE-->
						<a href="sc/pacienteAdd.php" class="btn btn-info" role="button" target="_blank">Nuevo Paciente</a>
