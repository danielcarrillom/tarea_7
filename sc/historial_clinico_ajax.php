...
$query=mysqli_query($conn, $sql);
	...
	$nestedData[] = "<td>
					<center><a href='sc/historial_clinicoEdit.php?id=".$row['id_historial_clinico']."' target='_blank' class='btn btn-warning'><i class='fas fa-edit'></i></a>
					
					<a href='sc/detail_historial_clinico.php?id=".$row['id_historial_clinico']."' target='_blank' class='btn btn-info'><i class='fas fa-eye'></i></a></td></center>";
