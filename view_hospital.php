...
<html>
	...
	<head>
		...
		<script type="text/javascript" language="javascript" src="js/datatable_hospital.js"></script>
		...
		<div class="panel panel-primary" id="content_table">
    		<div class="panel-heading">
        		<h3 class="panel-title"><i class="fas fa-file-signature"></i>  SISTEMA SEGUIMIENTO PACIENTES COVID-19</h3>
    					...
    					<div class="alert alert-success" style="font-size: 13pt; font-weight: bold;"><i class="fas fa-external-link-alt"></i>  Hospitales provincia de Arauco</div> 

    					<!--BOTÓN PARA AÑADIR NUEVO HOSPITAL-->
						<a href="sc/hospitalAdd.php" class="btn btn-info" role="button" target="_blank">Nuevo Hospital</a>
